                      ...
                      children: [
                        TableRow(
                          children: [
                            ...
                            Center(
                                child: Text(
                                    inventoryList['product_name'].toString())),
                            Center(
                                child: Text(
                                    inventoryList['description'].toString())),
                            Center(
                                child:
                                    Text(inventoryList['fragile'].toString())),
                            Center(
                                child: Text(
                                    inventoryList['perishable'].toString())),
                            Center(
                                child: Text(inventoryList['price'].toString())),
                          ],
                        ),
                      ]),
                ),
